    ...
    return (
        <div className='footer-container'>
            ...
            <div className='social-media align center'>
                ...
                <div className='out-circle'><a href="https://www.linkedin.com/in/raneem-hamzah-83a201319?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app " target='_blank'>
